...
const Form = props => (
  <form className='form-inline justify-content-center' onSubmit={props.getWeather}>
    <div className='form-group my-form'>
      ...
      <input type='text' className='form-control my-input' name='city' id='city' placeholder='City name...' />
    </div>
    <div className='form-group my-form'>
      <label className="sr-only" for="country">Country</label>
      <input type='text' className='form-control my-input' name='country' id='country' placeholder='Two letter country code...' />
    </div>
